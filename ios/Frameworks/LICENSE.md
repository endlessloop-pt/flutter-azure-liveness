...
AZURE AI FACE CLIENT SDK

Purpose- For use with Azure AI Vision Face Services
...
a) **General.** You may install and use any number of copies of the software to develop and test your applications for use with Azure AI Vision Face Services only.
